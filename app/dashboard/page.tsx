...
export default function DashboardPage() {
  ...
  // Officer's first name for greeting
      ...
      <main className="min-h-screen bg-gray-950 pt-20 px-6 md:px-8 lg:px-12 pb-16">
        <div className="max-w-7xl mx-auto space-y-8">
          ...
          <div className="pt-6 flex items-start justify-between">
            <div>
              <p className="text-xs text-green-500 uppercase tracking-widest font-semibold mb-1">
              ...
              <p className="text-gray-400 mt-1 text-sm">
                {user.email} · ShambAI Evidence Discovery Engine
              </p>
            </div>
            ...
            <div className="hidden md:block bg-gray-900 border border-gray-800 rounded-xl px-5 py-3 text-right">
              ...
              <p className="text-xl font-mono font-bold text-green-400 mt-0.5">*384*16051#</p>
            </div>
          </div>

          {/* Stats bar — live from /dashboard/stats */}
          <StatsBar />

          {/* How it works — shown when no farmers yet */}
          <div className="bg-gray-900 border border-gray-800 rounded-2xl p-6">
            ...
            {/* Table — live from /dashboard/farmers */}
          ...
          <div className="grid md:grid-cols-3 gap-4">
            {[
              {
                step: '01',
                title: 'Farmer dials USSD',
                desc: 'Farmer calls *384*16051# on any feature phone. 7–9 questions, under 2 minutes.',
                color: 'text-green-400',
              },
              {
                step: '02',
                title: 'Evidence discovered',
                desc: 'ShambAI queries M-Pesa, weather data, and Neo4j cooperative networks to build an evidence graph.',
                color: 'text-blue-400',
              },
              {
                step: '03',
                title: 'Officer verifies',
                desc: 'You review the evidence, upload documents, verify community ties, and add field notes.',
